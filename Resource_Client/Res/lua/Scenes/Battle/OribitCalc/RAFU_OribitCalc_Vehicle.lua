...
local RAFU_OribitCalc_Vehicle = class('RAFU_OribitCalc_Vehicle',{})
local Utilitys = RARequire('Utilitys')
local RAFU_Math = RARequire('RAFU_Math')
RARequire("RAFightDefine")

local ParabolaCfg = RARequire('RAFU_Cfg_OribitCalc_Vehicle').ParabolaCfg
...
function RAFU_OribitCalc_Vehicle:ctor(param)
...
function RAFU_OribitCalc_Vehicle:release()	
...
function RAFU_OribitCalc_Vehicle:_CheckParam(param)
	local result = false
...
function RAFU_OribitCalc_Vehicle:Begin()
    self.mIsExecute = true   
    local common = RARequire('common')
    self.mPastTime = 0
    self:_CalcInit()
    self:_CalcImmediately()
    print('RAFU_OribitCalc_Vehicle:Begin   angle:'..self.mAngle..' direction:'..self.mDirection)
...
-- 	}
-- }
function RAFU_OribitCalc_Vehicle:GetCalcDatas()
	return self.mCalcDatas
end

function RAFU_OribitCalc_Vehicle:Execute(dt)
...
function RAFU_OribitCalc_Vehicle:_CalcInit()
...
function RAFU_OribitCalc_Vehicle:_CalcImmediately()
...
return RAFU_OribitCalc_Vehicle
